...
The model being used is the Global Kinematic model.There are 4 state variables and 2 actuators.
...
The previous values I tried were N=10,dt=0.1.N=10,dt=0.05.

I arrived at these values by manual tuning. The predictions are for 2 seconds ahead and values updated every 0.1 seconds.
It allows for better/smoother actuator values as we approach a turn.
